...
// FIX ME - CRIAR UM WATCHDOG PARA CADA TASK
//Task0code: Cuida de tudo menos o Recebimento de mensagens.
void Task0code( void * pvParameters ){
  sprintf(Sbuffer,"Task0 running on core %i ", xPortGetCoreID());
  Serial_Println(bDebug, Sbuffer);

  UBaseType_t uxHighWaterMark;
  // Inspect our own high water mark on entering the task - Usado para estimar o stack
  uxHighWaterMark = uxTaskGetStackHighWaterMark( NULL );
  sprintf(Sbuffer,"Task0 Stack: %i ", uxHighWaterMark);
  Serial_Println(bDebug, Sbuffer);
...
//Task1code: Dedicada ao recebimento de mensagens
void Task1code( void * pvParameters ){
  sprintf(Sbuffer,"Task1 running on core %i ", xPortGetCoreID());
  Serial_Println(bDebug, Sbuffer);

  UBaseType_t uxHighWaterMark;
  // Inspect our own high water mark on entering the task - Usado para estimar o stack
  uxHighWaterMark = uxTaskGetStackHighWaterMark( NULL );
  sprintf(Sbuffer,"Task1 Stack: %i ", uxHighWaterMark);
  Serial_Println(bDebug, Sbuffer);
