...
void displayMessage(uint8_t msgID){ //Slaves Message
    ...
    switch (msgID){
      ...
      case 40:
        ...
        display.println("RSSI: " + String(slave.packetRssi));
        display.println("SNR: " + String(slave.packetSnr));
        display.println("Timer: " + String(millis() - slave.lastRecTime) + " ms");
        display.println("Com Error: " + String(comErrorCounter));
        display.println("Rec Msgs: " + String(comReceivedCounter));
        break;
      case 90:
        yield();
        display.fillScreen(ILI9341_BLACK);
        ...
        display.setTextColor(ILI9341_WHITE); display.setTextSize(2);
        display.setCursor(0, 0);
        display.println("SPIFFS Failed on Gateway");
        break;
      case 100:
        yield();
        display.fillScreen(ILI9341_BLACK);
     ...
     case 130:
        ...
        display.setTextColor(ILI9341_RED); display.setTextSize(2);
        display.setCursor(0, 0);
        display.println("Padding dos Structs errado. Favor corrigir!");
        break;
      case 255:
        break;
      default:
